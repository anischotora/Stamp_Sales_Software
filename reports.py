...
class ReportsWindow(ctk.CTkToplevel):
    ...
    def create_ui(self):
        ...
        ctk.CTkLabel(
            title_frame,
            text="Double-click a sale to view all category serial numbers",
    ...
    def create_sales_table(self, parent):
        ...
        self.sales_tree.bind(
            "<Double-1>",
            self.open_sale_details
        )
    ...
    def get_sale_serials(self, sale_id):
        ...
        try:
            ...
            self.report_title_label.configure(
                text=(
                    ...
                    f"{self.serial_search_entry.get().strip()}"
                )
            )
    ...
    def clear_serial_search(self):
        self.serial_search_entry.delete(
            0,
            "end"
        )
    ...
    def delete_selected_sale(self):
        ...
        confirm = messagebox.askyesno(
            ...
            (
                ...
                "The sold stamp quantity will be "
                "restored to stock.\n"
